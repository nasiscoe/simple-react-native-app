            ...
            <View style={[this.props.containerStyle, {
              ...
              ...(Platform.OS !== 'android' && {
                ...
                <View style={[
                ...
                ]}>
                    {
                      this.props.searchable && (
                        <View style={{width: '100%', flexDirection: 'row'}}>
                            <TextInput
                                style={[styles.input, this.props.searchableStyle, {color: theme.text, borderColor: theme.border}]}
                    ...
                    <ScrollView style={{width: '100%'}} nestedScrollEnabled={true} persistentScrollbar={true} {...scrollViewProps}>
